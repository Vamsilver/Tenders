...
public class Builder : User
{
    ...
    public Builder(string login, string password, string email, RoleType roleType, string phoneNumber, string nickname) 
    ...
    public bool CheckTheCompleteAbsenceOfAdditionalData()
    {
        return String.IsNullOrEmpty(PSRN) && String.IsNullOrEmpty(TIN) && String.IsNullOrEmpty(TRRC)
               && String.IsNullOrEmpty(Address) && String.IsNullOrEmpty(Director);
    }
}